# and ოპერატორი უპრო არი მიგრეკილი ფალსთან ამიტომაც იყენება რომ ყოველტვის ფალსი გაბოიტანოს მაგალითად:5 > 6 10 > 7 ამ შემთხვევაში ის გამოიტანს 5 > 6 იმიტომ რომ and მიგრეკილია ფალსთან(არასწორთან)
# or ოპერატორი უპრო არი მიგრეკილი თრუსთან ამიტომაც იყენება რომ ყოველტვის თრუ გაბოიტანოს მაგალითად:5 > 6 10 > 7 ამ შემთხვევაში ის გამოიტანს 10 > 7 იმიტომ რომ or მიგრეკილია თრუ(სწორითან)
